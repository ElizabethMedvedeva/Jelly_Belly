...
})({"4aBpp":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "6c685b155e8bc736";
"use strict";
...
var _bannerJs = require("../components/banner/js/banner.js");
var _bestSellersJs = require("../components/ui/best_sellers/best_sellers.js");
var _cardsJs = require("../components/cards/cards.js");
var _patchJs = require("../components/ui/patch/patch.js");
var _headerJs = require("../components/ui/header/header.js");
var _footerJs = require("../components/ui/footer/footer.js");
var _basketJs = require("../components/basket/basket.js");
async function init() {
    const root = document.getElementById("root");
    let openBtn = document.querySelector(".icon-cart");
    await (0, _basketJs.createBasket)(root, openBtn);
    const swipers = await (0, _bannerJs.getSwiperImages)();
    let cards = await (0, _cardsJs.getCards)();
    cards = shuffle(cards);
    cards = cards.slice(0, 6);
    const patches = await (0, _patchJs.getPatchesImg)();
    root.appendChild((0, _headerJs.Header)());
    (0, _bannerJs.createBanner)(root, swipers);
    (0, _bestSellersJs.createBestSellers)(root, cards);
    (0, _patchJs.createPatch)(root, patches);
    root.appendChild((0, _footerJs.Footer)());
}
init();
...
},{"../components/banner/js/banner.js":"1GFc7","../components/ui/best_sellers/best_sellers.js":"6VUw3","../components/cards/cards.js":"9pA0D","../components/ui/patch/patch.js":"7ZdS4","../components/ui/header/header.js":"2uHU9","../components/ui/footer/footer.js":"bwjC3","../components/basket/basket.js":"9py2R"}],"1GFc7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createBanner", ()=>createBanner);
parcelHelpers.export(exports, "getSwiperImages", ()=>getSwiperImages);
var _indexJs = require("../../../core/index.js");
parcelHelpers.exportAll(_indexJs, exports);
var _apiJs = require("../../../core/api.js");
var _swiper = require("swiper");
var _swiperDefault = parcelHelpers.interopDefault(_swiper);
var _swiperBundleMinCss = require("../styles/swiper-bundle.min.css");
...
async function getSwiperImages() {
    ...
    let result = (0, _apiJs.apiRequest)(swiperURL);
    return result;
}

},{"../../../core/index.js":"fyiI3","../../../core/api.js":"lCapC","swiper":"cCbRx","../styles/swiper-bundle.min.css":"8Z3Qr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lCapC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "findProduct", ()=>findProduct);
parcelHelpers.export(exports, "apiRequest", ()=>apiRequest);
var _constants = require("./constants");
const findProduct = async (search)=>{
    const url = new URL(`${(0, _constants.API_URL)}/cardss`);
...
async function apiRequest(URL1) {
    let response = await fetch(URL1);
    const result = await response.json();
    return result;
}

},{"./constants":"14HLO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"14HLO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "API_URL", ()=>API_URL);
parcelHelpers.export(exports, "chosenCardsKey", ()=>chosenCardsKey);
const API_URL = "https://64564c932e41ccf169191429.mockapi.io/api/v1";
const chosenCardsKey = "chosenCards";
...
},{"../../shared/create-shadow.js":"9JYAP","../../shared/effect-init.js":"5DnvG","../../shared/effect-target.js":"eKqS8","../../shared/effect-virtual-transition-end.js":"VhYFx","../../shared/utils.js":"dbikn","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8Z3Qr":[function() {},{}],"6VUw3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createBestSellers", ()=>createBestSellers);
var _cards = require("../../cards/cards");
var _cardsModal = require("./cards_modal");
function createBestSellers(root, cards) {
    ...
    for(let i = 0; i < cards.length; i++)(0, _cards.createCard)(bestSellersCards, cards[i]);
    (0, _cardsModal.createModal)(root);
    const cardsImage = bestSellersCards.querySelectorAll(".card_image");
    cardsImage.forEach((element)=>element.firstChild.onclick = (0, _cardsModal.openModal));
    bestSellers.appendChild(bestSellersCards);
    root.appendChild(bestSellers);
}

},{"../../cards/cards":"9pA0D","./cards_modal":"jzTTy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9pA0D":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function addToBasket(event) {
    let cardsID = (0, _store.getStore)((0, _constants.chosenCardsKey));
    if (!cardsID) cardsID = [];
    cardsID.push(event.target.parentNode.parentNode.id);
    (0, _store.setStore)((0, _constants.chosenCardsKey), cardsID);
}
async function getCards() {
    const cardsURL = "https://64564c932e41ccf169191429.mockapi.io/api/v1/cardss";
    let result = await (0, _api.apiRequest)(cardsURL);
    return result;
}

},{"../../core/api":"lCapC","../../core/store":"58stD","../../core/constants":"14HLO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"58stD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jzTTy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7ZdS4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createPatch", ()=>createPatch);
parcelHelpers.export(exports, "getPatchesImg", ()=>getPatchesImg);
var _apiJs = require("../../../core/api.js");
...
async function getPatchesImg() {
    ...
    let result = (0, _apiJs.apiRequest)(patchURL);
    return result;
}

},{"../../../core/api.js":"lCapC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2uHU9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const Header = ()=>{
    const header = (0, _helpers.createElement)({
        name: "header",
        classList: [
            "header"
        ]
    });
    const container = (0, _helpers.createElement)({
        name: "div",
        classList: [
            "header__container"
        ]
    });
    container.appendChild((0, _helpers.createElement)({
        name: "img",
        classList: [
            "logo"
        ],
    ...
    container.appendChild((0, _search.MainSearch)());
    const basket = (0, _helpers.createElement)({
        name: "div",
        classList: [
            "icon-cart"
        ]
    });
    basket.addEventListener("click", (0, _basket.openBasket));
    container.appendChild(basket);
    header.appendChild(container);
    return header;
};

},{"../../../helpers":"kEqbI","../../search/search":"6BTVQ","../../basket/basket":"9py2R","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kEqbI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _createElementsJs = require("./createElements.js");
parcelHelpers.exportAll(_createElementsJs, exports);

},{"./createElements.js":"6YylO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6YylO":[function(require,module,exports) {
/**
...
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createElement", ()=>createElement);
function createElement({ name , classList , attributes , text , childrens  }) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6BTVQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MainSearch", ()=>MainSearch);
var _searchLess = require("./search.less");
var _apiJs = require("../../core/api.js");
var _indexJs = require("../../helpers/index.js");
var _searchResultJs = require("./search-result.js");
var _emptySearchResultJs = require("./empty-search-result.js");
const MainSearch = ()=>{
    const root = (0, _indexJs.createElement)({
        name: "div",
        classList: [
            "main-search",
            "main-search_refined"
        ...
        childrens: [
            {
                ...
                childrens: [
                    ...
                    },
                    {
                        ...
                        classList: [
                            "main-search__action",
                            "main-search__action_refined"
                        ],
                        attributes: {
                            "data-action": "refined-search"
                        },
                        childrens: [
                            {
                                name: "span",
    ...
    form.addEventListener("click", (event)=>{
        if (event.target.getAttribute("data-action") === "refined-search") root.classList.add("main-search_refined");
    });
    form.querySelector("input").addEventListener("focus", ()=>{
        if (list.querySelector(".main-search__result-product")) root.classList.remove("main-search_refined");
    });
    form.addEventListener("input", ()=>{
        clearTimeout(delay);
        delay = setTimeout(()=>{
            (0, _apiJs.findProduct)(form.search.value.trim()).then((data)=>{
                list.innerHTML = "";
                data.forEach((product)=>{
                    list.appendChild((0, _searchResultJs.SearchResult)(product));
                });
                if (data.length === 0) list.appendChild((0, _emptySearchResultJs.EmptySearchResult)());
...
},{"./search.less":"eFMvI","../../core/api.js":"lCapC","../../helpers/index.js":"kEqbI","./search-result.js":"kYSti","./empty-search-result.js":"3VMh6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eFMvI":[function() {},{}],"kYSti":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "SearchResult", ()=>SearchResult);
var _searchResultLess = require("./search-result.less");
var _indexJs = require("../../helpers/index.js");
var _constantsJs = require("../../core/constants.js");
var _store = require("../../core/store");
const SearchResult = (product)=>{
    const searchResultElement = (0, _indexJs.createElement)({
        name: "li",
        classList: [
            "main-search__result-product",
            "result-product"
        ],
        childrens: [
            {
...
function addToBasket(event) {
    let cardsID = (0, _store.getStore)((0, _constantsJs.chosenCardsKey));
    if (!cardsID) cardsID = [];
    ...
    cardsID.push(cardID);
    (0, _store.setStore)((0, _constantsJs.chosenCardsKey), cardsID);
}

},{"./search-result.less":"8Ssr1","../../helpers/index.js":"kEqbI","../../core/constants.js":"14HLO","../../core/store":"58stD","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8Ssr1":[function() {},{}],"3VMh6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "EmptySearchResult", ()=>EmptySearchResult);
var _emptySearchResultLess = require("./empty-search-result.less");
var _indexJs = require("../../helpers/index.js");
const EmptySearchResult = ()=>{
    return (0, _indexJs.createElement)({
        name: "li",
        classList: [
            "main-search__result-empty"
        ],
        childrens: [
            {
                name: "h4",
...
},{"./empty-search-result.less":"9vnW7","../../helpers/index.js":"kEqbI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9vnW7":[function() {},{}],"9py2R":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createBasket", ()=>createBasket);
...
function clearBasket() {
    (0, _store.setStore)((0, _constants.chosenCardsKey), []);
...
async function fillCards() {
    ...
    for (let card of cardsArr)cardRender(wrapper, card);
}
...
async function decreaseQuantity(event) {
    ...
    (0, _store.setStore)((0, _constants.chosenCardsKey), chosenCard);
    await refreshBasket();
}
...
async function getSelectedCards() {
    const allCards = await (0, _cards.getCards)();
    const ids = getIdLocalStorage();
    if (!ids) return [];
    const selectedCards = allCards.filter((card)=>ids.find((id)=>card.id === id));
    return selectedCards;
}
function getIdLocalStorage() {
    const chosenStore = (0, _store.getStore)((0, _constants.chosenCardsKey));
    return chosenStore;
}
async function removeCard(event) {
    ...
    (0, _store.setStore)((0, _constants.chosenCardsKey), newBasketArray);
    await refreshBasket();
}
function getCardsQuantity() {
    const selectedCardID = getIdLocalStorage();
    const counter = {};
    for (let id of selectedCardID)if (id in counter) counter[id] += 1;
    else counter[id] = 1;
    return counter;
}
...
},{"../cards/cards":"9pA0D","../../core/store":"58stD","../../core/constants":"14HLO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bwjC3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Footer", ()=>Footer);
var _helpers = require("../../../helpers");
var _footerInformation = require("./footer-information");
var _footerLocation = require("./footer-location");
var _footerSocialMedia = require("./footer-social-media");
const Footer = ()=>{
    const footer = (0, _helpers.createElement)({
        name: "footer",
        classList: [
            "footer"
        ]
    ...
    container.appendChild((0, _footerInformation.FooterInformation)());
    container.appendChild((0, _footerSocialMedia.FooterSocialMedia)());
    container.appendChild((0, _footerLocation.FooterLocation)());
    footer.appendChild(container);
    return footer;
};

},{"../../../helpers":"kEqbI","./footer-information":"eiTPE","./footer-location":"he7Cy","./footer-social-media":"fGOZQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eiTPE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "FooterInformation", ()=>FooterInformation);
var _footerInformationLess = require("./footer-information.less");
var _helpers = require("../../../helpers");
const FooterInformation = ()=>{
    return (0, _helpers.createElement)({
        name: "div",
        classList: [
            "footer__information"
        ],
...
},{"./footer-information.less":"53ol5","../../../helpers":"kEqbI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"53ol5":[function() {},{}],"he7Cy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "FooterLocation", ()=>FooterLocation);
var _footerLocationLess = require("./footer-location.less");
var _helpers = require("../../../helpers");
...
},{"./footer-location.less":"hxcfK","../../../helpers":"kEqbI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hxcfK":[function() {},{}],"fGOZQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "FooterSocialMedia", ()=>FooterSocialMedia);
var _footerSocialMediaLess = require("./footer-social-media.less");
var _helpers = require("../../../helpers");
...
},{"./footer-social-media.less":"3aYoO","../../../helpers":"kEqbI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3aYoO":[function() {},{}]},["4aBpp","fyiI3"], "fyiI3", "parcelRequire39c3")
